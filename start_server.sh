...
echo "Starting WhisperX Diarization Server..."
...
# GPU optimization: Set CUDA library paths to prevent cuDNN version conflicts
# Prioritizes system cuDNN over virtual environment cuDNN
